...
import { RecipeGrid } from './RecipeInteractiveComponents';
import { 
  EggIcon, 
  WhiskIcon, 
  CupcakeIcon, 
...
// Main App Component with Typography Fixes and Enhanced Styling
const App = () => {
            ...
            <ul className="space-y-2">
              <li>
                ...
                >
                  ...
                  <span className="font-display tracking-wide">DASHBOARD</span>
                </button>
              </li>
              <li>
                <button 
                ...
                >
                  ...
                  <span className="font-display tracking-wide">RECIPES</span>
                </button>
              </li>
              <li>
                <button 
                ...
                >
                  ...
                  <span className="font-display tracking-wide">SUBSTITUTION CALCULATOR</span>
                </button>
              </li>
              <li>
                <button 
                ...
                >
                  ...
                  <span className="font-display tracking-wide">TEMPERATURE GUIDE</span>
                </button>
              </li>
              <li>
                <button 
                ...
                >
                  ...
                  <span className="font-display tracking-wide">SETTINGS</span>
                </button>
              </li>
            </ul>
          </nav>
            ...
            <div>
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  <div className="relative">
                    <select 
                      className="bg-gray-700 text-gray-200 px-4 py-2 rounded-md border border-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent appearance-none pr-8 font-display tracking-wide"
                  ...
                  <button 
                    className="bg-amber-600 hover:bg-amber-700 text-white px-4 py-2 rounded-md transition-colors duration-200 font-display tracking-wide"
                  ...
                  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 max-w-2xl w-full">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div>
                          <label className="block text-gray-300 mb-2 font-display tracking-wide">Ingredients (include)</label>
                          <input 
                            type="text" 
                        ...
                        <div>
                          <label className="block text-gray-300 mb-2 font-display tracking-wide">Ingredients (exclude)</label>
                          <input 
                            type="text" 
                            className="bg-gray-700 text-gray-200 px-4 py-2 rounded-md border border-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent w-full"
                        ...
                        <div>
                          <label className="block text-gray-300 mb-2 font-display tracking-wide">Cuisine Type</label>
                        ...
                        <div>
                          <label className="block text-gray-300 mb-2 font-display tracking-wide">Meal Type</label>
                          <select className="bg-gray-700 text-gray-200 px-4 py-2 rounded-md border border-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent w-full">
                        ...
                        <div>
                          <label className="block text-gray-300 mb-2 font-display tracking-wide">Cooking Time (max)</label>
                          <select className="bg-gray-700 text-gray-200 px-4 py-2 rounded-md border border-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent w-full">
                        ...
                        <div>
                          <label className="block text-gray-300 mb-2 font-display tracking-wide">Calories (max)</label>
                          <select className="bg-gray-700 text-gray-200 px-4 py-2 rounded-md border border-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent w-full">
                      ...
                      <div className="flex justify-end">
                        <button 
                          className="bg-gray-700 hover:bg-gray-600 text-gray-300 font-medium py-2 px-4 rounded transition-colors duration-200 mr-2 font-display tracking-wide"
                          onClick={toggleAdvancedSearch}
                        >
                          Cancel
                        </button>
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden hover:border-amber-600 transition-colors duration-300">
                    ...
                    <div className="p-4">
                      <h3 className="text-lg font-semibold text-cream mb-2 font-display tracking-wide">Avocado Toast</h3>
                      <div className="text-sm text-gray-400 mb-2">
                        <span>Quick breakfast • 10 min</span>
                      </div>
                      <div className="text-amber-400 text-sm font-display tracking-wide">AI Recommended</div>
                    </div>
                  </div>
                  <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden hover:border-amber-600 transition-colors duration-300">
                    <div className="h-32 bg-gray-700 flex items-center justify-center relative">
                    ...
                    <div className="p-4">
                      <h3 className="text-lg font-semibold text-cream mb-2 font-display tracking-wide">Mushroom Risotto</h3>
                      <div className="text-sm text-gray-400 mb-2">
                        <span>Dinner • 45 min</span>
                      </div>
                      <div className="text-amber-400 text-sm font-display tracking-wide">Based on your preferences</div>
                    </div>
                  </div>
                  <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden hover:border-amber-600 transition-colors duration-300">
                    <div className="h-32 bg-gray-700 flex items-center justify-center relative">
                    ...
                    <div className="p-4">
                      <h3 className="text-lg font-semibold text-cream mb-2 font-display tracking-wide">Blueberry Muffins</h3>
                      <div className="text-sm text-gray-400 mb-2">
                        <span>Breakfast • 30 min</span>
                      </div>
                      <div className="text-amber-400 text-sm font-display tracking-wide">Trending now</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                <div className="bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                  <h3 className="text-amber-400 font-semibold mb-2 font-display tracking-wide">RECENT RECIPES</h3>
                ...
                <div className="bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                  <h3 className="text-amber-400 font-semibold mb-2 font-display tracking-wide">FAVORITE INGREDIENTS</h3>
                  <ul className="text-gray-300 space-y-2">
                    <li className="flex justify-between">
                      <span>Butter</span>
                ...
                <div className="bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                  <h3 className="text-amber-400 font-semibold mb-2 font-display tracking-wide">COOKING STATS</h3>
                  <ul className="text-gray-300 space-y-2">
                    <li className="flex justify-between">
              ...
              <div className="mt-8">
                ...
                <div className="bg-gray-700/50 p-4 rounded-lg border border-gray-600">
                  ...
                  <div className="flex">
                    ...
                    />
                    <button className="bg-amber-600 hover:bg-amber-700 text-white px-4 py-2 rounded-r-md transition-colors duration-200 font-display tracking-wide">
                      Ask
                    </button>
                  </div>
                </div>
          ...
          {activeTab === 'settings' && (
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-amber-400 mb-3 font-display tracking-wide">ACCOUNT SETTINGS</h3>
                  <div className="bg-gray-700/50 p-4 rounded-lg border border-gray-600 space-y-4">
                    <div>
                      <label className="block text-gray-300 mb-2 font-display tracking-wide">Display Name</label>
                      <input 
                        type="text" 
                        className="bg-gray-700 text-gray-200 px-4 py-2 rounded-md border border-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent w-full"
                ...
                <div>
                  <h3 className="text-lg font-semibold text-amber-400 mb-3 font-display tracking-wide">PREFERENCES</h3>
                  <div className="bg-gray-700/50 p-4 rounded-lg border border-gray-600 space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-300 font-display tracking-wide">Dark Mode</span>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-gray-300 font-display tracking-wide">Email Notifications</span>
                    ...
                    <div>
                      <label className="block text-gray-300 mb-2 font-display tracking-wide">Default Measurement System</label>
                      <select className="bg-gray-700 text-gray-200 px-4 py-2 rounded-md border border-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent w-full">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-amber-400 mb-3 font-display tracking-wide">AI ASSISTANT SETTINGS</h3>
                  <div className="bg-gray-700/50 p-4 rounded-lg border border-gray-600 space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-300 font-display tracking-wide">Enable AI Recipe Suggestions</span>
                      <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out rounded-full bg-amber-600">
                        <label className="absolute left-0 w-6 h-6 transition duration-100 ease-in-out transform bg-white rounded-full cursor-pointer translate-x-6"></label>
                        <input type="checkbox" className="opacity-0 w-0 h-0" checked readOnly />
                      </div>
                    ...
                    <div>
                      <label className="block text-gray-300 mb-2 font-display tracking-wide">AI Suggestion Frequency</label>
                      <select className="bg-gray-700 text-gray-200 px-4 py-2 rounded-md border border-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent w-full">
                ...
                <div className="flex justify-end">
                  <button className="bg-gray-700 hover:bg-gray-600 text-gray-300 font-medium py-2 px-4 rounded transition-colors duration-200 mr-2 font-display tracking-wide">
                    Cancel
                  </button>
